...
class PopularMoviesResponseModel {
  ...
  final int? page;
  final List<PopularMovieResponseResult>? results;
  ...
  factory PopularMoviesResponseModel.fromJson(Map<String, dynamic> json) =>
      PopularMoviesResponseModel(
        page: json["page"],
        results:
            List<PopularMovieResponseResult>.from(json["results"].map((x) => PopularMovieResponseResult.fromJson(x))),
...
class PopularMovieResponseResult {
  PopularMovieResponseResult({
    required this.adult,
  ...
  factory PopularMovieResponseResult.fromJson(Map<String, dynamic> json) => PopularMovieResponseResult(
        adult: json["adult"],
